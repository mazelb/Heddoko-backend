namespace DAL.Migrations
{
    ...
    public partial class UserIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            RenameColumn("dbo.AspNetUsers", "Phone", "PhoneNumber");
        ...
        {
            RenameColumn("dbo.AspNetUsers", "PhoneNumber", "Phone");
            AlterColumn("dbo.AspNetUsers", "Phone", c => c.String(maxLength: 255));
