...
namespace Heddoko.Controllers
{
    ...
    public class ShirtsController : BaseAdminController<Shirt, ShirtAPIModel>
    {
        ...
        public ShirtsController(ApplicationUserManager userManager, UnitOfWork uow): base(userManager, uow) { }
        ...
        {
            List<HistoryNotes> item = UoW.ShirtRepository.HistoryNotes(id);
