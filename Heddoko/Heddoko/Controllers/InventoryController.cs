...
namespace Heddoko.Controllers
{
    ...
    public class InventoryController : BaseController
    {
        ...
        private List<AssembliesAPIModel> GetAssemblies()
        {
            List<AssembliesAPIModel> assemblies = new List<AssembliesAPIModel>();
            ...
            assemblies.Add(new AssembliesAPIModel(AssembliesType.Brainpacks, brainpacks, brainpackArr.Min()));

            assemblies.Add(new AssembliesAPIModel(AssembliesType.Sensors, sensors, sensorArr.Min()));

            assemblies.Add(new AssembliesAPIModel(AssembliesType.Shirts, shirts, shirtArr.Min()));

            assemblies.Add(new AssembliesAPIModel(AssembliesType.Pants, pants, pantsArr.Min()));

            assemblies.Add(new AssembliesAPIModel(AssembliesType.Kits, kits, kitsArr.Min()));
