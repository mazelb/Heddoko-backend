...
angular.module("admin/dirPagination.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("admin/dirPagination.tpl.html",
